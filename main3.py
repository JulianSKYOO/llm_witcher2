...
class DialogueSystem:
    ...
    def setup_prompts(self):
        ...
        self.qa_prompt = ChatPromptTemplate.from_messages([
            ("system", "You are Triss from The Witcher 2. Use the context and chat history for dialogue.\n\n{context}"),
            MessagesPlaceholder("chat_history"),
            ("user", "{input}")
        ])
...
class StreamlitInterface:
    ...
    def run(self):
        ...
        st.title("Witcher 2 Dialogue Chatbot with DPO and Toxicity Control")
